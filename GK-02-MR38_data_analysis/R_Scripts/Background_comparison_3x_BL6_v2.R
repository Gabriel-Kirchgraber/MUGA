...
ideogram_complex_STR = "Background_comparison_3xBL6_ideogram_complex.jpg"
ideogram_simple_STR = "Background_comparison_3xBL6_ideogram_simple.jpg"
report_STR = "Background_comparison_3xBL6.xlsx"
...
gg1 = gg1 + geom_text(data = plot_DF, mapping = aes(x=7.8, y=Position, label = refsnp_id), size = 1.5)
gg1 = gg1 + scale_x_continuous(breaks = plot_DF$Order, labels = plot_DF$Sample.ID, limits = c(0,8))
