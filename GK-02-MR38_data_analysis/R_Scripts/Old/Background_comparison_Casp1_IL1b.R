...
library("ggplot2")
options(scipen=999)
# Compare the Casp1 and IL1b mice to all backgrounds 
...
write.csv2(combined_DF, 'S:/AG/AG-Knauf/Daten/AG Knauf/Gabriel Kirchgraber/GK-01.00-MUGA/GK-01.20-MR38_data_analysis/R_Scripts/Output/Background_analysis_IL1bA_raw.csv', na = '')
write.csv2(df, 'S:/AG/AG-Knauf/Daten/AG Knauf/Gabriel Kirchgraber/GK-01.00-MUGA/GK-01.20-MR38_data_analysis/R_Scripts/Output/Background_analysis_IL1bA_diff_per_chr.csv', na = '')
write.csv2(track_SNPs_TB, 'S:/AG/AG-Knauf/Daten/AG Knauf/Gabriel Kirchgraber/GK-01.00-MUGA/GK-01.20-MR38_data_analysis/R_Scripts/Output/Background_analysis_IL1bA_dropped_SNPs.csv', na = '')
